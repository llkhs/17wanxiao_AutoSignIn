...
**😡2021.01.29 完美校园服务器把github的ip给ban了，所以获取不了登录信息，解决办法是代码加入https代理，有时间再折腾折腾**
...
## 也不用抓包了，支持自动填写，其他学校的自测。
 <img src="assets/img/E7537C28-185B-4E55-887D-1B56BD78C7F0.jpeg" width="300" alt="抓包结果"/><br/>
